...
interface TopSalesItemInterface {
	name: string,
	type: string,
	price: number,
	count: number
...
const TopSalesItem = ({ name, type, price, count }: TopSalesItemInterface) => {
					...
					<div className='flex-shrink-0'>
						<div className='ratio ratio-1x1 me-3' style={{ width: 48 }}>
							<div
								...
								<span className='fw-bold'>{name[0]}</span>
							</div>
						</div>
					</div>
			...
			<CardHeader>
				...
				<CardActions>
					<Button
						...
						icon='Summarize'
						tag='a'
						to={`../${demoPages.sales.subMenu.salesList.path}`}>
						Detailed Report
					</Button>
				</CardActions>
			</CardHeader>
