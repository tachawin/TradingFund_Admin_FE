		...
		<>
			...
			<div className='row'>
				<div className='col-lg-8'>
					...
					<TransferAction currency='$' amount={200} status={demoStatus} img='../../assets/logos/logo1.png' />
					<TransferAction currency='$' amount={80} status='Completed' img='../../assets/logos/logo2.png' />
					<TransferAction currency='€' amount={70} status='Completed' img='../../assets/logos/logo3.png' />
					<TransferAction
						currency='€'
						amount={120}
						status='Failed'
