...
interface CommonUpcomingEventsInterface {
	isFluid?: boolean
}


const CommonUpcomingEvents = ({ isFluid }: CommonUpcomingEventsInterface) => {
	...
	const formik = useFormik({
		initialValues: {
			...
			employee: `${USERS[0].name} ${USERS[0].surname}`,
			location: 'Maryland',
								...
								<tr key={item.id}>
									...
									<td>
										<Dropdown>
											...
											<DropdownMenu>
												{Object.values(EVENT_STATUS).map((value: any) => (
					...
					<div className='row g-4'>
						<div className='col-lg-6'>
							<FormGroup
								...
								<Input
									value={moment(new Date()).format('MMM Do YYYY, h:mm a')}
									readOnly
									disabled
								/>
							</FormGroup>
