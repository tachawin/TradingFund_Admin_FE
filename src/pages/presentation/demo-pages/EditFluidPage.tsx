...
const EditFluidPage = () => {
	...
	useEffect(() => {
		if (eventItem)
			formik.setValues({
				...
				eventStart: moment(eventItem.start).toDate(),
				eventEnd: moment(eventItem.end).toDate(),
	...
	return (
		<PageWrapper title={demoPages.editPages.subMenu.editFluid.text}>
			<SubHeader>
				<SubHeaderLeft>
					...
					<SubheaderSeparator />
					<Avatar srcSet='../../../assets/img/wanna/wanna2.webp' src='../../../assets/img/wanna/wanna2.png' size={32} />
					<span>
										...
										<CardBody>
											<div className='row g-4 align-items-center'>
												<div className='col-xl-auto'>
													<Avatar srcSet='../../../assets/img/wanna/wanna2.webp' src='../../../assets/img/wanna/wanna2.png' />
												</div>
							...
							<Card stretch style={{ minHeight: 600 }}>
								...
								<CardBody isScrollable>
									<Calendar
										...
										toolbar={false}
										localizer={localizer}
										events={events.filter((i: any) => i.user === USERS[0])}
