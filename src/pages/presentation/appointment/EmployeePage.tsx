...
const EmployeePage = () => {
	...
	const userTasks = dummyEventsData.filter((f: any) => f.assigned.username === data);
									...
									<Dropdown>
										<DropdownToggle>
											<Button color='info' icon='Compare' isLight>
												Compared to{' '}
												<strong>{parseInt(moment().format('YYYY')) - 1}</strong>.
											</Button>
										</DropdownToggle>
										<DropdownMenu isAlignmentEnd size='sm'>
											<DropdownItem>
												<span>{parseInt(moment().format('YYYY')) - 2}</span>
											</DropdownItem>
											<DropdownItem>
												<span>{parseInt(moment().format('YYYY')) - 3}</span>
											</DropdownItem>
										</DropdownMenu>
									</Dropdown>
								</CardActions>
