...
const FormsListPage = () => {
	...
	const utilities = componentsMenu.utilities.subMenu;
	...
	return (
		<PageWrapper title={`${componentsMenu.utilities.text} List`}>
			<SubHeader>
				<SubHeaderLeft>
					<label
			...
			<Page>
				<div className='row'>
					{utilities && Object.values(utilities)
						...
						.map((utility) => (
							<div key={utility.id} className='col-md-3'>
								<Card
