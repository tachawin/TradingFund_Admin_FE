...
const ModalPage = () => {
	...
	const [fullScreenStatus, setFullScreenStatus] = useState<string | boolean | null>(null);
	...
	const _content = longContentStatus ? (
		<>
			<p>
	...
	const _generalUsage = `const [state, setState] = useState(false);`;
