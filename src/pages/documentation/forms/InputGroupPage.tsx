...
import { _selectOptions } from './SelectPage';
		...
		<PageWrapper title={componentsMenu.forms.subMenu?.inputGroup.text}>
			...
			<Page>
				<div className='row'>
												...
												<InputGroup>
													<InputGroupText
														...
														<Checks
															...
															value='username'
															checked={
																formikCR.values.exampleInputRadio === 'username'
															}
														/>
													</InputGroupText>
													<Input
												...
												<InputGroup>
													<InputGroupText
														...
														<Checks
															...
															value='email'
															checked={
																formikCR.values.exampleInputRadio === 'email'
															}
														/>
													</InputGroupText>
													<Input
					...
					{/*						</Button> */}
					{/*					</DropdownToggle> */}
					{/*					<DropdownMenu isAlignmentEnd>{_dropdownInner}</DropdownMenu> */}
					{/*				</InputGroup> */}
					{/*			</div> */}
					{/*		</CardBody> */}
					{/*	</Card> */}
