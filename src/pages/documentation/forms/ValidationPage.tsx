...
const _generalUsage = `<COMPONENT // Input || Select || Textarea || ChecksGroup || Checks
...
const _sampleUsage = `import React from 'react';
import { useFormik } from 'formik';
			...
			<Page>
				<div className='row'>
					...
					<div className='col-12'>
						<Card>
							<CardBody>
								<CardCodeView>{_sampleUsage}</CardCodeView>
							</CardBody>
						</Card>
					</div>
					<div className='col-12'>
