				...
				<div className='row'>
					...
					<div className='col-12'>
						<Card>
							...
							<CardBody>
								<CommonHowToUse isPrism>{_seriesPropTypes}</CommonHowToUse>
								<CommonDesc>
									More information,{' '}
									<AlertLink
					...
					<div className='col-12'>
						<Card>
							...
							<CardBody>
								<CommonHowToUse isPrism>{_optionsPropTypes}</CommonHowToUse>
								<CommonDesc>
									More information,{' '}
									<AlertLink
						...
						<Card>
							...
							<CardBody>
								<div className='row g-3'>
									{componentsMenu.charts.subMenu && Object.values(componentsMenu.charts.subMenu).map((menu) => {
										if (
